...
ActiveRecord::Schema.define(version: 2021_07_30_090849) do
  ...
  create_table "authors_roles", id: false, force: :cascade do |t|
    ...
    t.index ["author_id"], name: "index_authors_roles_on_author_id"
    t.index ["role_id"], name: "index_authors_roles_on_role_id"
  end
